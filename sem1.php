  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <form class="insert-form" id="insert_form" method="post" action="">
            <hr>
            <h3 class="text-center">Enter Semester 1 Marks Details.</h3>
            <hr>
            <div class="input-field">
                <table class="table table-dark" id="table_field1">
                    ...
                    <tr> 
                        ...
                        <td><input class="form-control" type="number" name="sem[]" value="1"></td>    
                    </tr>
                </table>
                    ...
                    <?php 
                       ...
                       if(isset($_POST['save'])){
                           ...
                           foreach($email as $key => $value){
                               $save = "INSERT INTO sem1(email,sem,sub_id,subject,marks)VALUES('".$value."','".$sem[$key]."','".$sub_id[$key]."','".$subject[$key]."','".$marks[$key]."')";
       ...
       <br>
       <hr>
            <h3 class="text-center">Semester 1 Marks Details.</h3>
        <hr>
        ...
        <table class="table table-striped">
            ...
            <?php 
                $e=$_SESSION['email'];
                $select = "SELECT * FROM sem1 WHERE email='".$e."' ";
                $result = mysqli_query($db,$select);
                while($row = mysqli_fetch_array($result)){ ?>
            <tr>
                ...
                <td> <a href="delete1.php?id=<?php echo $row['id'] ?>" <input type="button" class="btn btn-danger"> Delete </a>
            </tr>
            <?php
                }
            ?>
        ...
        <center>
            <form action="pdf_gen1.php" method="POST">
