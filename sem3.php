  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <form class="insert-form" id="insert_form" method="post" action="">
            <hr>
            <h3 class="text-center">Enter Semester 3 Marks Details.</h3>
            <hr>
            <div class="input-field">
                <table class="table table-dark" id="table_field1">
                    ...
                    <tr> 
                        ...
                        <td><input class="form-control" type="number" name="sem[]" value="3"></td>    
                    </tr>
                </table>
                    ...
                    <?php 
                       ...
                       if(isset($_POST['save'])){
                           ...
                           foreach($email as $key => $value){
                               $save = "INSERT INTO sem3(email,sem,sub_id,subject,marks)VALUES('".$value."','".$sem[$key]."','".$sub_id[$key]."','".$subject[$key]."','".$marks[$key]."')";
                               $query = mysqli_query($db,$save);
                           }

                        if(isset($_GET['delete'])){
                            $id = $_GET['delete'];
                            $mysqli->query("DELETE FROM sem3 WHERE id=$id") or die($mysqli->error());
                        }
       ...
       <br>
       <hr>
            <h3 class="text-center">Semester 3 Marks Details.</h3>
        <hr>
        ...
        <table class="table table-striped">
            ...
            <?php 
                $e=$_SESSION['email'];
                $select = "SELECT * FROM sem3 WHERE email='".$e."' ";
                $result = mysqli_query($db,$select);
                while($row = mysqli_fetch_array($result)){ ?>
            <tr>
                ...
                <td> <a href="delete3.php?id=<?php echo $row['id'] ?>" <input type="button" class="btn btn-danger"> Delete </a>
            </tr>
            <?php
                }
            ?>
        ...
        <center>
            <form action="pdf_gen3.php" method="POST">
